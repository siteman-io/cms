...
class MenuPanel extends Component implements HasForms
{
    ...
    public function mount(MenuPanelInterface $menuPanel): void
    {
        ...
        return $form
            ->schema([
                Components\View::make('filament-tables::components.empty-state.index')
                    ->viewData([
                        'heading' => __('siteman::menu.panel.empty.heading'),
                        'description' => __('siteman::menu.panel.empty.description'),
    ...
    {
        return view('siteman::menu.livewire.panel');
    }
}
